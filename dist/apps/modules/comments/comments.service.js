...
var CommentService = /** @class */ (function () {
    ...
    CommentService.prototype.getCommentsForPost = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.comments.find({
                        where: {
                            post: id,
                        },
                        relations: {
    ...
    CommentService.prototype.getCommentsMadeByAcc = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.comments.find({
                        where: {
    ...
    CommentService.prototype.getCommentsMadeByAccForPost = function (post, account) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.comments.find({
                        where: {
    ...
    CommentService.prototype.countPostComments = function (post) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.comments.count({
                        where: {
                            post: post,
                        },
                    })];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.comments.findAndCount({
                                where: filters,
                                skip: skip,
                                take: take,
                                relations: {
    ...
    CommentService.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.comments.findOne({
                            where: {
                                id: id,
                            },
                            relations: {
    ...
    CommentService.prototype.create = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                response = this.comments.create(body);
                return [2 /*return*/, this.comments.save(response)];
            });
        });
    };
    CommentService.prototype.update = function (id, updates) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.comments.update(id, updates)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, this.comments.delete(id)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, response];
                }
