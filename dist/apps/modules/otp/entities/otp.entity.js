...
var Otp = /** @class */ (function () {
    ...
    Otp.prototype.updated = function () {
        this.updatedAt = new Date();
    };
    Otp.prototype.insert = function () {
        if (!(0, class_validator_1.isEmail)(this.email)) {
    ...
    ], Otp.prototype, "updated", null);
    __decorate([
        (0, typeorm_1.BeforeInsert)(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], Otp.prototype, "insert", null);
    Otp = __decorate([
        (0, typeorm_1.Entity)()
    ], Otp);
    return Otp;
